...
(setq doom-unicode-font (font-spec :family "Iosevka" :size 19)
      doom-variable-pitch-font (font-spec :family "sans" :size 15))
...
(setq user-full-name "Amanjeev Sethi"
      user-mail-address "aj@amanjeev.com")
...
(org-roam-db-autosync-mode) ;; org-roam should be available on startup

;; org roam ui stuff. see packages.el
